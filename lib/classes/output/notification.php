...
class notification implements \renderable, \templatable {
    ...
    /**
     * @var array $customjs The params would have to be in the same order as passed to js_call_amd i.e.
    ...
    /**
     * Set any custom js scripts that is required to manipulate the notification content.
     *
