...
class core_secondary_testcase extends advanced_testcase {
     ...
     * @param int $siteorder The order for the siteadmin node
     * @param int $courseorder The order for the course node
     * @param int $moduleorder The order for the module node
     ...
     */
    public function test_setting_initialise($context, $expectedfirstnode) {
        global $PAGE, $SITE;
        $this->resetAfterTest();
        $this->setAdminUser();
        $pagecourse = $SITE;
        ...
        $node = new mock_secondary_navigation();
...
class mock_secondary_navigation extends secondary {
    /**
     * mock_secondary_navigation constructor.
     */
    ...
    /**
     * Expose the parent get_leaf_nodes
     *
