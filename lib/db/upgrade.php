...
function xmldb_main_upgrade($oldversion) {
    ...
    if ($oldversion < 2019082400.01) {
        ...
        if (!file_exists($CFG->dirroot . '/blocks/community/communitycourse.php')) {
            ...
            $capabilitiestoberemoved = ['moodle/community:add', 'moodle/community:download', 'block/community:addinstance'];
    ...
    if ($oldversion < 2019082400.02) {
        ...
        upgrade_main_savepoint(true, 2019082400.02);
    }
