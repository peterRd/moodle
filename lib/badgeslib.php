...
function badges_update_site_backpack($id, $data) {
    ...
    if ($backpack = badges_get_site_backpack($id)) {
        return badges_save_external_backpack($data, $id);
    }
    return false;
}
 ...
 */
function badges_save_external_backpack(stdClass $data, ?int $id = null) {
    global $DB;
 ...
 * @param int|null $id The id of the backpack if updating.
 * @return int
 */
function badges_save_backpack_credentials(stdClass $data, ?int $id = 0) {
    global $DB;
