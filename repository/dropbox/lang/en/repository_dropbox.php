...
$string['dropbox_scoped'] = 'Scoped Dropbox';
$string['dropbox_scoped_help'] = 'Enable this if you are connecting to a Dropbox app that requires specific scopes.';
...
$string['scoped_info'] = 'Dropbox has introduced a new scoped apps that require scopes to be set. Any legacy apps created as \'Full Dropbox\' apps(as per Moodle docs) will still use the permission model and not require this to connect. <b>If you are using a legacy app disable this checkbox.</b>';
