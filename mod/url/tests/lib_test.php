...
class mod_url_lib_testcase extends advanced_testcase {
     ...
     * @param int $userid User id override instead of defaulting to the logged in user
     * @return bool|calendar_event
     */
    private function create_action_event($courseid, $instanceid, $eventtype, $userid = 0) {
        $event = new stdClass();
