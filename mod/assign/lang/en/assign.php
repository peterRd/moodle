...
$string['formvalidationfailed'] = 'Form validation failed.';
$string['graded'] = 'Graded';
$string['gradealreadymodified'] = 'The submission has been graded by somebody else. Please reload the page to view the changes.';
