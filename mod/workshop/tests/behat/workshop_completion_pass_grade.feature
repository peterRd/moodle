...
Feature: Workshop submission and assessment with pass grade activity completion
  ...
  Background:
    ...
    And the following "activities" exist:
      | activity | name         | intro                     | course | idnumber  | submissiontypetext | submissiontypefile | completion | completiongradeitemnumber | submissiongradepass | gradinggradepass |
      | workshop | TestWorkshop | Test workshop description | c1     | workshop1 | 2                  | 1                  | 2          | 1                         | 40                  | 60               |
  ...
  Scenario: Add and assess submissions in workshop with javascript enabled
    And I log in as "student1"
    And I am on "Course1" course homepage
    Then the "TestWorkshop" "workshop" activity with "auto" completion should be marked as complete
    And I log out
    And I log in as "student2"
    And I am on "Course1" course homepage
    And "Completed: TestWorkshop (did not achieve pass grade)" "icon" should exist in the "li.modtype_workshop" "css_element"
    And I log out
    And I log in as "student3"
    And I am on "Course1" course homepage
    And the "TestWorkshop" "workshop" activity with "auto" completion should be marked as not complete
    And I log out
