...
class big_search_form implements renderable, templatable {
    ...
    public $guestuser;
    /** @var bool Whether the include favourites checkbox is checked. */
    public $includeonlyfavourites;
    ...
    /**
     * Set Include favourites values
     *
     * @param mixed $value Bool.
     */
    public function set_includeonlyfavourites($value) {
        $this->includeonlyfavourites = $value;
    }
    ...
    public function export_for_template(renderer_base $output) {
        ...
        $data->includeonlyfavourites = $this->includeonlyfavourites;
