...
$string['preloadpreviousattempt'] = 'Allow the lesson to preload existing attempts';
$string['preloadpreviousattempt_help'] = 'If enabled, any navigation back to a question will load the previous answer for that particular user.';
