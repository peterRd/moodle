...
$string['privacy:metadata:grades:grader'] = 'The ID of the user who last submitted the grade.';
...
$string['privacy:metadata:history:grader'] = 'The ID of the user who last submitted the grade when versioning occured.';
