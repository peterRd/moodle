...
Feature: Students will be marked as completed and pass/fail
  ...
  Background:
    ...
    And the following "activities" exist:
      | activity | course | idnumber | name                 | intro                   | assignsubmission_onlinetext_enabled | assignsubmission_file_enabled | completion | completionview | completionusegrade | gradepass |
      | assign   | C1     | a1       | Test assignment name | Submit your online text | 1                                   | 0                             | 2          | 1              | 1                  | 50        |
  ...
  Scenario: Confirm completion (incomplete/pass/fail) are set correctly
    ...
    And the "Test assignment name" "assign" activity should be marked as "fail"
    And I log out
    And I log in as "student2"
    And I am on "Course 1" course homepage
    And the "Test assignment name" "assign" activity with "auto" completion should be marked as complete
    And the "Test assignment name" "assign" activity should be marked as "pass"
    And I log out
    And I log in as "student3"
    And I am on "Course 1" course homepage
    And the "Test assignment name" "assign" activity with "auto" completion should be marked as not complete
