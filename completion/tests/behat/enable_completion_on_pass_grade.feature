...
Feature: Students will be marked as completed if they have achieved a passing grade.
  ...
  Background:
    ...
    And the following "activities" exist:
      | activity | course | idnumber | name                 | intro                   | assignsubmission_onlinetext_enabled | assignsubmission_file_enabled | completion | completionpassgrade | completionusegrade | gradepass |
