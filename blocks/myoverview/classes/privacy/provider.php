...
class provider implements \core_privacy\local\metadata\provider, user_preference_provider {
    ...
    public static function get_metadata(collection $collection) : collection {
        $collection->add_user_preference('block_myoverview_user_sort_preference',
            'privacy:metadata:overviewsortpreference');
        $collection->add_user_preference('block_myoverview_user_view_preference',
    ...
    public static function export_user_preferences(int $userid) {
        ...
        if (isset($preference)) {
            writer::export_user_preference('block_myoverview', 'block_myoverview_user_sort_preference',
        ...
        if (isset($preference)) {
            writer::export_user_preference('block_myoverview', 'block_myoverview_user_view_preference',
                get_string($preference, 'block_myoverview'),
        ...
        if (isset($preference)) {
            writer::export_user_preference('block_myoverview', 'block_myoverview_user_grouping_preference',
                get_string($preference, 'block_myoverview'),
